...
//   }
//   // void setJamOp(bool senin, bool selasa, bool rabu, bool kamis, bool jumat,
//   //     bool sabtu, bool minggu) {
//   //   jamOp = [senin, selasa, rabu, kamis, jumat, sabtu, minggu];
//   // }
...
//     String a = '${categories.first.jam}${categories.first.menit}';
//     int an = int.parse(a);
...
//         ? '0'
//         : '${categories.first.jam}${categories.first.menit}';
//     int an = int.parse(a);
//     String b = jamOp[now] == 'Buka 24 jam' || jamOp[now] == 'Tutup'
//         ? '0'
//         : '${jamOp[now].substring(0, 2)}${jamOp[now].substring(3, 5)}';
