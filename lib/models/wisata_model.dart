...
List<Wisata> listWisata = [
  ...
  Wisata(
      image: 'assets/images/telaga-ciburial.webp',
      nama: 'Telaga Ciburial',
      alamat: 'Tapos I',
      alamatKec: 'Kecamatan Tenjolaya',
      hariOp: [true, true, true, true, false, true, true],
      tempClosed: false,
      ...
      camping: true,
      deskripsi:
          'Wisata Telaga Ciburial adalah tempat yang tepat dan asik untuk menyegarkan fikiran, wisata ini manawarkan kesegaran dari mata air alami. lokasinya yang berada di daerah perbukitan dan memiliki view sawah di sekitarnya juga menjadi nilai plus tersendiri dan tersedia juga camping ground.',
      lat: -6.6595238,
      long: 106.7209644,
      distance: 0.0,
      kategori: 'Rekreasi',
      imageGalerys: ['assets/images/telaga-ciburial2.jpg']),
  Wisata(
      image: 'assets/images/curug-muara.jpg',
      nama: 'Curug Muara',
      alamat: 'Tapos I',
      alamatKec: 'Kecamatan Tenjolaya',
      hariOp: [true, true, true, true, true, true, true],
      ...
      camping: true,
      deskripsi:
          'Curug Muara berada di bawah kaki Gunung Salak yang lokasinya memiliki air terjun serta sungai untuk arung jeram. Aliran air yang ada  sangat menyegarkan, jernih, dan bebas bau kaporit sehingga selain memanjakan mata juga menyegarkan kondisi tubuh.',
      lat: -6.6556275,
      long: 106.7033856,
      distance: 0.0,
      kategori: 'Air Terjun',
      imageGalerys: [
        'assets/images/curug-muara2.jpg',
        'assets/images/curug-muara3.jpg'
      ]),
];
